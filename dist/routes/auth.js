...
exports.router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userInput, error, foundUser, validaPassword, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userInput = req.body;
                error = validateUser(userInput).error;
                if (error)
            ...
            case 1:
                ...
                return [4 /*yield*/, bcrypt_1.default.compare(userInput.password, foundUser.get('password'))];
            case 2:
                validaPassword = _a.sent();
                if (!validaPassword)
                    return [2 /*return*/, res.status(400).send('Invalid email or password')];
                token = foundUser.schema.methods.generateAuthToken(foundUser.id);
